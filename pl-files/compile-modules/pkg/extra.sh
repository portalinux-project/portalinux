...
compile_extra_pkgs(){
	...
	# libgcc and libstdc++
	_setup_gcc rfs
	_compile_ac_pkg "$output/libstdc++/files/opt" "$gcc_dir" \
	...
	_compile_ac_pkg "$output/ncurses/files/opt/lib/libncursesw.so" "$ncurses_dir" \
	...
	# nano
	_compile_ac_pkg "$output/nano/files/opt" "$nano_dir" \
